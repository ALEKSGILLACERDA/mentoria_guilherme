...
def main(termos_de_busca: Optional[List[str]] = None, offset_final: int = 50) -> None:
    ...
    offsets: range = range(0, 640, 10)

    todas_as_vagas: List[Dict[str, Any]] = coletar_todas_as_vagas(termos_de_busca, offsets)
